...
1. docs/math-foundations.md — the mathematical basis for EVERY modeling family, with arxiv citations:
   ...
   c. BIS optimization: formulate the candidate ranking exactly (combinatorial optimization over loadout slots with coupled timeline evaluation), the search space size, and the approximation/duality that keeps ~96 candidates tractable; any published theory for such item-recommendation problems.
