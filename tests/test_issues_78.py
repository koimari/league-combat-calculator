...
CONTROL_IDS = {
    ...
    "scoreboardDialog": ("controls", "scoreboard"),
    "scoreboardClose": ("controls", "scoreboard"),
    "scoreboardPaste": ("controls", "scoreboard"),
    "scoreboardFile": ("controls", "scoreboard"),
    "scoreboardApply": ("controls", "scoreboard"),
