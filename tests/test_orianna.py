...
from src.calculator.champions import orianna
...
class TestReviewedCrowdControl:
    """Orianna's reviewed crowd control, and what declaring it clears.
    ...
    def test_declared_kinds_are_the_ones_the_cached_kit_gives(self):
        data = cc_review.kit("Orianna")
        assert orianna.MODULE_CC == {
            "Q": "none",
            "W": "slow",
            "E": "none",
            "R": "stun",
    ...
    def test_a_timed_fimbulwinter_fight_is_fully_certified(self):
        coverage = cc_review.fimbulwinter_coverage("Orianna")
