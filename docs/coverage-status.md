...
| Surface-area backlog rows open | 7 | `docs/surface-area-backlog.md` |
...
| `docs/surface-area-backlog.md` | 7 | everything the surface-area campaigns surfaced and did not close |
