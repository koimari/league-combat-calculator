...
from a complete reading, and 33 derive their
...
| In-fight STACK LEVELS | 3 | the engine, once a stack timeline reaches the cast |
| In-fight counts, full by default | 15 | already complete; the option removes |
| In-fight counts, derived default | 33 | the engine; the option is an override |
