...
354 champion options, 26 ask for a count of
...
from a complete reading, and 4 derive their
...
|---|---|---|
| In-fight counts, still asked | 26 | the engine, once each is derived |
| In-fight counts, full by default | 15 | already complete; the option removes |
| In-fight counts, derived default | 4 | the engine; the option is an override |
