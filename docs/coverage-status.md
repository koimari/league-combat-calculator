...
| Surface-area backlog rows open | 23 | `docs/surface-area-backlog.md` |
...
| `docs/surface-area-backlog.md` | 23 | everything the surface-area campaigns surfaced and did not close |
