...
| Surface-area backlog rows open | 26 | `docs/surface-area-backlog.md` |
...
| `docs/surface-area-backlog.md` | 26 | everything the surface-area campaigns surfaced and did not close |
