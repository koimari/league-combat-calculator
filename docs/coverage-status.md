...
from a complete reading, and 26 derive their
...
| In-fight STACK LEVELS | 10 | the engine, once a stack timeline reaches the cast |
| In-fight counts, full by default | 15 | already complete; the option removes |
| In-fight counts, derived default | 26 | the engine; the option is an override |
