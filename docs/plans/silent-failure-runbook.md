...
|---|---|---|---|
| public evaluations | 1324 / 1033 / 706 | `bench_coupled_optimizer.py:320` (`body["evaluations"]`) | VERIFIED (3champ), CARRIED (others) |
