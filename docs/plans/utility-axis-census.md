...
| `self_heal` | 10 | `champions/healing_contract.py:49` -> bodies `healing_legacy.py:494`, registry `:417` (57 champions) |
...
| Pyke | P | `aura_or_stat` | `self_shield` | partial | `healing_legacy.py:489` | AD from bonus health (1 per 14); Pyke is already in GREY_HEALTH_RULE_CHAMPIONS |
...
| Tahm Kench | E | `self_shield` | `self_heal` | yes | `healing_legacy.py:489` | grey health to shield; Tahm Kench is already in GREY_HEALTH_RULE_CHAMPIONS |
