...
| `src/calculator/value_source_receipt.py` | `src/calculator/value_ref.py` | the revision a declaration's numbers were read from, and how one is resolved | `SourceReceipt`, `_entry_receipt`, `receipt_for`, `UnsourcedDeclarationError` | 96 |
