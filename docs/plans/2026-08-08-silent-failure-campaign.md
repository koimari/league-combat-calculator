...
7. **Declarations outrank prose.** Phase 3's behaviour frontier reports counter 1 (runtime item-name
   ...
   > `_reattribute_empowered_swings` (`damage.py:10717`), which moves damage between two authored
   ...
   > `_apply_command_amp` (`damage.py:10316`) and `_apply_general_amplifiers` (`damage.py:10227`)
