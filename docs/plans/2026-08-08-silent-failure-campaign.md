...
7. **Declarations outrank prose.** Phase 3's behaviour frontier reports counter 1 (runtime item-name
   ...
   > `raw_active, source.damage_type, resists, state.magic_amp` (`damage.py:9056`) — and
   ...
   > (`damage.py:9894`) for physical packets, `_apply_liandry_reprice` (`damage.py:10780`) for magic
   ...
   > `_reattribute_empowered_swings` (`damage.py:12022`), which moves damage between two authored
   ...
   > `_apply_command_amp` (`damage.py:11288`) and `_apply_general_amplifiers` (`damage.py:11193`)
   ...
   > onto a second subject by `_copied_on_hit_packet` (`damage.py:9550`), for which
