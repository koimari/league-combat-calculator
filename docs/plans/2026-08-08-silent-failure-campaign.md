...
7. **Declarations outrank prose.** Phase 3's behaviour frontier reports counter 1 (runtime item-name
   ...
   > (`damage.py:9894`) for physical packets, `_apply_liandry_reprice` (`damage.py:10592`) for magic
   ...
   > `_reattribute_empowered_swings` (`damage.py:11643`), which moves damage between two authored
   ...
   > `_apply_command_amp` (`damage.py:11124`) and `_apply_general_amplifiers` (`damage.py:11005`)
