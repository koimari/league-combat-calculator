...
class InputOptionStatBonuses:
    """The four sourced stat deltas an equipped item's state controls grant."""
...
def resolve_stat_effects(
    ...
    *,
    ...
    # for one number.
    input_bonus_ap = input_option_stat_bonuses(items, item_options).bonus_ap
