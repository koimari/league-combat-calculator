...
_ATTACKER_STATE_HOMES: Mapping[str, tuple[str, str]] = {
    ...
    "Lost Chapter": (
        "fight.rotation.mana_declarations._enlighten_decl_for",
...
_TARGET_MODELED_IMPLS: Mapping[str, str | None] = {
    ...
    "Catalyst of Aeons": "interpreters.sustain.declared_sustain",
    "Cryptbloom": DECLARED,
    "Cull": DECLARED,
    "Death's Dance": DECLARED,
    "Diadem of Songs": DECLARED,
    "Doran's Blade": "interpreters.sustain.declared_sustain",
    "Doran's Ring": "interpreters.sustain.declared_sustain",
