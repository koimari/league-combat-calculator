...
_DECLARATIONS: tuple[MechanicCapability, ...] = (
    ...
    *(
        ...
        for slug, rune in (
            ...
            # -- minor runes, by path --
            ("absorb_life", "Absorb Life"),
            ("triumph", "Triumph"),
            ("presence_of_mind", "Presence of Mind"),
            ("legend_alacrity", "Legend: Alacrity"),
            ("legend_haste", "Legend: Haste"),
            ("legend_bloodline", "Legend: Bloodline"),
            ("coup_de_grace", "Coup de Grace"),
            ("cheap_shot", "Cheap Shot"),
            ("taste_of_blood", "Taste of Blood"),
            ("sudden_impact", "Sudden Impact"),
            ("sixth_sense", "Sixth Sense"),
            ("grisly_mementos", "Grisly Mementos"),
            ("deep_ward", "Deep Ward"),
