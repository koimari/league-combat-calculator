...
Design rules (``architecture.md``, "Design rules"): categorical
mechanics are small typed declarations with public receipts; missing
values raise naming the declaration; the kernel never invents a number
or policy the caches do not evidence.
"""
