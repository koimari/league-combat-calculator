...
const GLYPHS = {
  ...
  "folio": [["rect", {x: "7.5", y: "3.5", width: "13", height: "13", rx: "1.5"}], ["path", {d: "M3.5 7.5v10a3 3 0 0 0 3 3h10"}]],
  "clear": [["circle", {cx: "12", cy: "12", r: "8.5"}], ["path", {d: "m9 9 6 6M15 9l-6 6"}]],
  "refresh": [["path", {d: "M20.5 12A8.5 8.5 0 1 1 19.5 8M20.5 3.5V8h-4.5"}]],
  "history": [["path", {d: "M3.5 12A8.5 8.5 0 1 0 4.5 8M3.5 3.5V8H8M12 7.5V12l3 2"}]],
  ...
  "pick": [["circle", {cx: "12", cy: "12", r: "8.5"}], ["path", {d: "m8 12.5 2.5 2.5 5.5-6"}]],
  "sort": [["path", {d: "M8 4.5v15M4.5 16 8 19.5 11.5 16M16 19.5v-15M12.5 8 16 4.5 19.5 8"}]],
...
type IconProps = Omit<SVGProps<SVGSVGElement>, "name"> & { name: IconName; size?: number; label?: string; leading?: boolean };

/** Decorative by default; pass `label` when the icon is the only content of a control. `leading` spaces it from a following label. */
export function Icon({ name, size = 16, label, leading, className, style, ...rest }: IconProps) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"
    ...
    aria-hidden={label ? undefined : true} focusable="false" className={className}
    style={{ verticalAlign: "-0.22em", flexShrink: 0, marginRight: leading ? "0.4rem" : undefined, ...style }} {...rest}>
    {GLYPHS[name].map(([tag, attrs], index) => createElement(tag, { key: index, ...attrs }))}
  </svg>;
}
