...
def _record_merge(  # pylint: disable=too-many-arguments
    name: str,
    state: str,
...
def _record_routes(  # pylint: disable=too-many-arguments
    name: str,
    champion_data: Mapping[str, Any],
    parsed: Mapping[str, Any],
    options: Mapping[str, Any],
...
def _derived_order(  # pylint: disable=too-many-arguments
    name: str,
    parsed: Mapping[str, Any],
    champion_data: Mapping[str, Any],
