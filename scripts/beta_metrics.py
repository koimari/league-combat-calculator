...
(thresholds and semantics live in docs/beta-metrics.md):
...
The module is importable: ``compute_scorecard`` is what ``GET /api/metrics``
serves, so the endpoint and the CLI share one definition of the gate.
"""
...
def compute_scorecard(
    *,
    ...
    report_path = (
        ...
        else REPO_ROOT / "data" / "staleness.json"
    )
